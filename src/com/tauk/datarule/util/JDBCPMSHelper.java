...
public class JDBCPMSHelper {
	//durid数据源
	private static DataSource dataSource;
	
	static {
		try {
			 InputStream inputStream = JDBCPMSHelper.class.getClassLoader().getResourceAsStream("jdbc.properties");
	...
	private static JDBCPMSHelper instance = null;
	
	/**
	 * 获取单例
	 * @return 单例
	 */
	public static JDBCPMSHelper getInstance() {
		if(instance == null) {
			synchronized(JDBCPMSHelper.class) {
				if(instance == null) {
					instance = new JDBCPMSHelper();
				}
			}
		}
		return instance;
